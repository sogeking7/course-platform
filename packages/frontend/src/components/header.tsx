...
export const HomeHeader = (props: any) => {
  return (
    <header className="pl-3 pr-4 flex relative z-[1000] py-2 h-[55px] w-full border-b border-neutral-300  shadow-sm bg-white">
      <div className="flex items-center w-full justify-between gap-8">
        <div className="flex gap-6 items-center">
          ...
          <div className="max-xl:hidden w-[120px] md:w-[140px]">
            <Logo />
          </div>
          <MySheet />
        </div>
